...
subtitle: "Heating tolerance of an ectotherm does not vary when temperature’s influence on biological rates is accounted for"
...
fig2 <- plot_grid(p2, legend, rel_widths =c(3, 0.4))
fig2
...
save_plot(plot = fig2, filename = paste0("../figures/", journal, "/fig2.", i), dpi = 300, base_width = 12, bg = "white")
