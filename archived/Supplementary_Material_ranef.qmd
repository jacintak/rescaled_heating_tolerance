...
# AJ added - interspecific gamma value for plotting
inter_gg <- 0.071385
...
rate_ratios <- species_data %>% 
  ...
  mutate(delta_tau2_hat = f_beta_fun(exp(beta_K * (tau_a1-tau_a2)) * (lambda_ratio ^ (1 - gg)) * g_beta_fun(delta_tau1)),
         delta_tau2_hat_inter = f_beta_fun(exp(beta_K * (tau_a1-tau_a2)) * (lambda_ratio ^ (1 - inter_gg)) * g_beta_fun(delta_tau1)),
         delta_tau2_hat_inter_old = f_beta_fun(exp(beta_K * (tau_a1-tau_a2)) * (lambda_ratio ^ (1 - 0.7656548)) * g_beta_fun(delta_tau1)))
